/* 
  ...
  Function: Sets up student in Firebase
  Description: It saves the data of students' picked classes and role
    ...
    documentReference.get().then((datasnapshot) {
      if (datasnapshot.exists && datasnapshot.data['code'] == classCode.text) {
        ...
        Firestore.instance
            ...
            .updateData({
          "users":
              FieldValue.arrayUnion([SignUp.documentID]) // changed // important
        }); // this works
        ...
        if (addClass) {
          ...
          AlertDialog success = AlertDialog(
            title: Text("Success!"),
            content: Text("Your class has been added. Add another one."),
          );
                    ...
                    onPressed: () async {
                      ...
                      if (className.text == '' || classCode.text == '') {
                        ...
                        AlertDialog confirm = AlertDialog(
                          ...
                          content: Text(
                              "Are you sure you are done joining classes?"),
                          actions: [
                            noButton,
                            yesButton,
                          ],
